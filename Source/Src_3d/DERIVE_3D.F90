...
#endif
            dermodgradrho, derudotlapu, derkeng, derlogs, dermvel, derdvrho, dermprho, &
            derlgrhodust, derdmag, dermgvort, dervortx, dervorty, dervortz, dermgstrnrt, dervisc, &
            derstress, dermgdivu, gradp_dir, dergrdpx, dergrdpy, dergrdpz, deravgpres, dergrdp, &
            derradvel, derazivel, derxvelrot, deryvelrot, dermagvelrot, dermagvortrot, &
      ...
      do k = lo(3), hi(3)
         do j = lo(2), hi(2)
            do i = lo(1), hi(1)
               ...
               visc(i,j,k,1) = visc_fun(strnrt,L(i,j,k))
            end do
         end do
      end do
      ...
      do k = lo(3), hi(3)
         do j = lo(2), hi(2)
            do i = lo(1), hi(1)
               ...
               wz = wzcen(i,j,k)
               strnrt = strnrt_fun_3d(ux,uy,uz,vx,vy,vz,wx,wy,wz)
               stress(i,j,k,1) = stress_fun(strnrt,L(i,j,k))
            end do
         end do
      end do
