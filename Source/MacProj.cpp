	...
	rhs.setVal(0.0);
	    ...
	    //	    std::cout << " ... and done \n";
            ...
            if (use_forces_in_trans)
            {
                ...
                ns_level.getForce(tvelforces,bx,1,Xvel,BL_SPACEDIM,prev_time,Smf[Smfi],Smf[Smfi],rhs[Smfi],Density);
  
	      //  	      std::cout << "getForce call (MacProj 2) \n";
		//OG	      ns_level.getForce(tvelforces,bx,1,Xvel,BL_SPACEDIM,prev_time,Smf[Smfi],Smf[Smfi],rhs[Smfi],Density,level);
	      // 	      rhs.SumBoundary(geom().periodicity());
	      //  	      std::cout << " ... and done \n";
